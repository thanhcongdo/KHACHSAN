                    ...
                    <tbody>
                        <c:forEach items="${listKS}" var="o">
                            <tr>
                                ...
                                <td>${o.TENKHACHSAN}</td>
                                <td>${o.DIACHI}</td>
                                <td><iframe src="${o.GGMAP}" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></td>
                                <td><img src="${o.HINHANH}"></td>
                                <td>${o.HANG}</td>
                                <td><input type="checkbox" <c:if test="${o.NGUNG==true}">checked=checked</c:if> class="switch-input" disabled="disabled"></td>
                                    <td>
                                        <a href="loadKhachSanControl?IDKS=${o.MAKHACHSAN}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Sửa">&#xE254;</i></a>
                                    <a href="DeleteKhachSanControl?IDKS=${o.MAKHACHSAN}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Xóa">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <div class="modal-content">
                    <form action="AddKhachSanControl" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Hạng</label>
                                <textarea name="HANG" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>Ngừng</label>
